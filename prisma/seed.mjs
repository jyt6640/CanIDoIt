...
const DATA = [
  ...
  },
  {
    ...
    warnings: [
      {
        key: 'italy-common-001',
        city: 'rome',
        title: '스페인 계단 등 역사 유적지의 계단에 앉아 쉬거나 음식을 먹지 마세요',
        category: '거리·공공장소',
        risk: '높음',
        type: '지역 조례',
        range: '로마 스페인 계단과 역사적 기념물',
        reason: '로마시 도시경찰 규정은 역사적 기념물과 유물에 눕거나 앉는 행동을 금지하며, 스페인 계단(Scalinata di Trinità dei Monti)을 보호 대상 장소로 명시합니다.',
        alternative: '계단은 통행용으로만 사용하시고, 휴식은 인근 광장 벤치나 노천카페를 이용하세요.',
        diffFromKorea: '관광객이 흔히 쉬는 계단처럼 보여도 로마의 역사적 기념물에는 별도 도시 규정이 적용될 수 있습니다.',
        locations: ['거리·공공장소'],
        sources: [{
          title: 'Roma Capitale - Regolamento di Polizia Urbana',
          url: 'https://www.comune.roma.it/web-resources/cms/documents/Assemblea_Capitolina_n._43_2019_1.pdf',
          checkedAt: '2026-07-21',
          kind: 'OFFICIAL',
          platform: 'Roma Capitale',
        }],
      },
      {
        key: 'italy-common-002',
        title: '기차나 시내버스를 탄 직후 티켓을 단말기에 넣어 개표(펀칭)하지 않은 채 이동하지 마세요',
        category: '대중교통',
        risk: '높음',
        type: '대중교통 이용 규칙',
        range: '이탈리아 지역열차의 종이 승차권과 일부 시내 교통권',
        reason: 'Trenitalia의 종이 지역열차 승차권은 탑승 전에 유효화해야 하지만, 디지털 지역권은 선택한 출발 시각에 자동 유효화되어 별도 펀칭이 필요하지 않습니다. 시내 교통권은 도시별 규칙을 따라야 합니다.',
        alternative: '종이 지역열차표는 플랫폼 단말기에서 유효화하고, 디지털 표와 시내 교통권은 발권 화면과 현장 안내를 확인하세요.',
        locations: ['지하철', '대중교통'],
        sources: [{
          title: 'Trenitalia - Travelling on Regional trains',
          url: 'https://www.trenitalia.com/en/information/travelling-on-regional-trains.html',
          checkedAt: '2026-07-21',
          kind: 'OFFICIAL',
          platform: 'Trenitalia',
        }],
      ...
      {
        key: 'italy-common-003',
        title: '길거리나 해변에서 파는 위조 명품을 구매하지 마세요',
        category: '쇼핑·결제',
        risk: '높음',
        type: '법률',
        range: '이탈리아 전역',
        reason: '이탈리아 세관당국은 가격·판매 상황상 위조품임을 의심할 수 있는 물건을 구매한 최종 구매자에게 행정 제재가 적용될 수 있다고 안내합니다.',
        alternative: '유적지 길거리 노점상에서 판매하는 가짜 명품 가방, 시계, 선글라스 등은 구매하지 마세요.',
        diffFromKorea: '판매자뿐 아니라 위조 가능성을 알 수 있었던 최종 구매자도 행정 제재 대상이 될 수 있습니다.',
        locations: ['거리·공공장소', '시장'],
        sources: [{
          title: 'Agenzia delle Dogane e dei Monopoli - Shopping on the internet',
          url: 'https://www.adm.gov.it/portale/en/acquisti-su-internet',
          checkedAt: '2026-07-21',
          kind: 'OFFICIAL',
          platform: 'ADM',
        }],
